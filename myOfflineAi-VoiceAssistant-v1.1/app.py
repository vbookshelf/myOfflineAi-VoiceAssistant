...
# License: MIT
# Version: 1.1 (Added webcam feature)
#----------------------
...
DEFAULT_TOP_P = 0.95
DEFAULT_TOP_K = 50 # Not necessary when using top_p
...
<head>
    ...
    <style>
        ...
        .sidebar-select, .sidebar-textarea, .sidebar-btn {
            width: 100%;
            padding: 0.65rem;
...
<body>
    <div class="app-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="sidebar-section">
                <div class="collapsible-header" id="webcam-toggle">
    ...
    const ui = {
        ...
        webcamContent: document.getElementById('webcam-content'),
        webcamFeed: document.getElementById('webcam-feed'),
        webcamCanvas: document.getElementById('webcam-canvas'),
        startStopWebcamBtn: document.getElementById('start-stop-webcam-btn'),
        captureWebcamBtn: document.getElementById('capture-webcam-btn')
    };
    ...
    function setupCollapsible(toggle, content) {
        toggle.addEventListener('click', () => {
            ...
            // Special handling for webcam to stop it when closed
            if (toggle === ui.webcamToggle && !isOpen) {
                stopWebcam();
            }
        });
    }
    ...
    function setupEventListeners() {
        ...
        setupCollapsible(ui.webcamToggle, ui.webcamContent);
    ...
    function setControlsEnabled(enabled, { keepMicActive = false } = {}) {
        ...
        // The capture button should only be enabled if the webcam is active AND other controls are enabled.
    ...
    function captureWebcamImage() {
        ...
        const dataUrl = ui.webcamCanvas.toDataURL('image/jpeg');
        imageBase64Array.push(dataUrl);
        updatePreviews(); // This existing function will show the thumbnail
    }
