...
3. Inside you will find a folder named: myOfflineAi-VoiceAssistant-v2.1
4. Place myOfflineAi-VoiceAssistant-v2.1 on your desktop.
...
6. Press Enter
If you get an error, then type in these commands in the terminal to manually cd into myOfflineAi-VoiceAssistant-v2.1 folder:
cd Desktop
cd myOfflineAi-VoiceAssistant-v2.1
...
8. Press Enter
9. Open the myOfflineAi-VoiceAssistant-v2.1 folder
...
8. Navigate to the myOfflineAi-VoiceAssistant-v2.1 folder that's on your desktop
